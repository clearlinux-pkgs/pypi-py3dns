...
Source0  : https://files.pythonhosted.org/packages/20/58/0d73b890c6df037add249d321edbecda3d91fd5c66ebc7a263525b2044a4/py3dns-4.0.1.tar.gz
...
%prep
%setup -q -n py3dns-4.0.1
cd %{_builddir}/py3dns-4.0.1
pushd ..
cp -a py3dns-4.0.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708968789
