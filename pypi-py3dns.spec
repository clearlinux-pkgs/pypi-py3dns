...
Source0  : https://files.pythonhosted.org/packages/76/67/d7e745a5248bd7ecf2b76d3a1c8280255cbbdcb21174b171cf3c87740836/py3dns-4.0.2.tar.gz
...
%prep
%setup -q -n py3dns-4.0.2
cd %{_builddir}/py3dns-4.0.2
pushd ..
cp -a py3dns-4.0.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717696320
